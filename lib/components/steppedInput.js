...
var _mapActions=require('../screens/map/mapActions');
...
props));
_this._onPressDecrement=_this._onPressDecrement.bind(_this);
_this._onPressIncrement=_this._onPressIncrement.bind(_this);return _this;
}_createClass(SteppedInput,[{key:'_onPressDecrement',value:function _onPressDecrement()

{
if(this.props.withdrawAmount>_constants.MinWithdrawAmount){
var withdrawAmount=this.props.withdrawAmount-10;
this.props.updateMapAction({withdrawAmount:withdrawAmount});
}
}},{key:'_onPressIncrement',value:function _onPressIncrement()

{
if(this.props.withdrawAmount<_constants.MaxWithdrawAmount){
var withdrawAmount=this.props.withdrawAmount+10;
this.props.updateMapAction({withdrawAmount:withdrawAmount});
}
...
_react2.default.createElement(_reactNative.Text,{style:styles.currency},'SGD'),
_react2.default.createElement(_reactNative.Text,{style:styles.textInput},this.props.withdrawAmount.toString()),
...
}}]);return SteppedInput;}(_react.Component);
...
(0,_reactRedux.connect)(mapStateToProps,{updateMapAction:_mapActions.updateMap})(SteppedInput);