...
var merchant=_merchants2.default[this.props.navigation.state.params.index];
...
_react2.default.createElement(_FontAwesome2.default,{name:'chevron-left',size:20,color:'#FFFFFF'})),
...
}}]);return MerchantDetails;}(_react.Component);MerchantDetails.navigationOptions=function(_ref2){var navigation=_ref2.navigation,screenProps=_ref2.screenProps;return{title:null,header:null};};exports.default=MerchantDetails;
