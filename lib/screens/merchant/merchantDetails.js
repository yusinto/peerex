...
createStripeSource=function _callee(_ref2){var cardNumber=_ref2.cardNumber,cvc=_ref2.cvc,expiryMonth=_ref2.expiryMonth,expiryYear=_ref2.expiryYear;var result,resultJson;return regeneratorRuntime.async(function _callee$(_context){while(1){switch(_context.prev=_context.next){case 0:_context.prev=0;


console.log('createStripeSource: email: '+_this.props.email+', stripeCustomerId: '+_this.props.stripeCustomerId+', '+cardNumber+' '+cvc+' '+expiryMonth+' '+expiryYear);_context.next=4;return regeneratorRuntime.awrap(

fetch(_constants.API+'/create-source',
{
method:'POST',
headers:{
...
console.log('failed to create stripe source: '+_context.t0);case 15:case'end':return _context.stop();}}},null,_this2,[[0,12]]);},_this.



onValidateCardSuccessful=function _callee2(cardNumber,cardExpiry,cardCvc){var _cardExpiry$split,_cardExpiry$split2,expiryMonth,expiryYear,stripeSource;return regeneratorRuntime.async(function _callee2$(_context2){while(1){switch(_context2.prev=_context2.next){case 0:_cardExpiry$split=
cardExpiry.split('/'),_cardExpiry$split2=_slicedToArray(_cardExpiry$split,2),expiryMonth=_cardExpiry$split2[0],expiryYear=_cardExpiry$split2[1];

console.log('onValidateCardSuccessful : '+cardNumber+', '+expiryMonth+', '+expiryYear+' '+cardCvc);_context2.next=4;return regeneratorRuntime.awrap(


_this.createStripeSource({
cardNumber:cardNumber,
expiryMonth:expiryMonth,
expiryYear:expiryYear,
cvc:cardCvc}));case 4:stripeSource=_context2.sent;




_this.props.updateMerchantDetailsAction(stripeSource);return _context2.abrupt('return',



Promise.resolve(cardNumber));case 7:case'end':return _context2.stop();}}},null,_this2);},_this.
...
_react2.default.createElement(_reactNative.Text,{style:styles.label},this.state.last4?this.state.last4:'add a card')))),
...
_react2.default.createElement(_reactNativeCheckout.AddCard,{
addCardHandler:this.onValidateCardSuccessful,
styles:{},
onCardNumberBlur:function onCardNumberBlur(){return console.log('card number blurred');},
onCardNumberFocus:function onCardNumberFocus(){return console.log('card number focused');},
onCvcFocus:function onCvcFocus(){return console.log('cvc focused');},
onCvcBlur:function onCvcBlur(){return console.log('cvc blurred');},
onExpiryFocus:function onExpiryFocus(){return console.log('expiry focused');},
onExpiryBlur:function onExpiryBlur(){return console.log('expiry blurred');},
onScanCardClose:function onScanCardClose(){return console.log('scan card closed');},
onScanCardOpen:function onScanCardOpen(){return console.log('scan card opened');},
...
}}]);return MerchantDetails;}(_react.Component);MerchantDetails.navigationOptions=function(_ref3){var navigation=_ref3.navigation,screenProps=_ref3.screenProps;return{title:null,header:null};};MerchantDetails.propTypes={mutate:_react.PropTypes.func.isRequired,stripeCustomerId:_react.PropTypes.string.isRequired,id:_react.PropTypes.string.isRequired};
...
(0,_reactRedux.connect)(mapStateToProps,{updateMerchantDetailsAction:_merchantDetailsActions.updateMerchantDetails})(componentWithMutation);