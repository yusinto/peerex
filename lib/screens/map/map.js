...
}}]);return Map;}(_react.Component);Map.navigationOptions={title:'How much do you need?',header:{visible:true,style:{backgroundColor:_styles.colors.primary},titleStyle:{color:_styles.colors.white,fontSize:16,fontWeight:'300'},tintColor:_styles.colors.white}};exports.default=Map;
