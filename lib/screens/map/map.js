...
}}]);return Map;}(_react.Component);Map.navigationOptions={title:'How much do you need?',headerStyle:{backgroundColor:_styles.colors.primary},headerTitleStyle:{color:_styles.colors.white,fontSize:16,fontWeight:'300'},headerLeft:null};exports.default=Map;
