...
reducer;var _loginActions=require('./loginActions');var initialState={id:'',email:'',loginType:'',stripeCustomerId:''};function reducer(){var state=arguments.length>0&&arguments[0]!==undefined?arguments[0]:initialState;var action=arguments.length>1&&arguments[1]!==undefined?arguments[1]:{};var
